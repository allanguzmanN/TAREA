 ...
 * @author allan
 */
public class frmVentaVehiculos extends javax.swing.JFrame {

    /**
     * Creates new form frmVentaVehiculos
     */
    public frmVentaVehiculos() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmVentaVehiculos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmVentaVehiculos().setVisible(true);
            }
        });
    }
